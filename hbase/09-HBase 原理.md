...
### 错误图解
![](assets/markdown-img-paste-2020040122104425.png)

这张图是有一个**错误点**：应该是每一个 RegionServer 就只有一个 HLog，而不是一个 Region 有一个 HLog。

### 正确图解
![](assets/markdown-img-paste-20200401221159826.png)
...
### 整体的物理结构 
![](assets/markdown-img-paste-20200401221657624.png)
...
![](assets/markdown-img-paste-20200401221840483.png)
...
![](assets/markdown-img-paste-20200401222236691.png)
...
![](assets/markdown-img-paste-20200401222606394.png)
...
![](assets/markdown-img-paste-20200401222708123.png)
